...
import com.example.anju.angelwatches.jsonEntityObjects.PaymentResponseObject;
import com.example.anju.angelwatches.jsonEntityObjects.ServerObject;
import com.example.anju.angelwatches.network.GsonRequest;
import com.example.anju.angelwatches.network.VolleySingleton;
...
public class PayPalCheckoutActivity extends AppCompatActivity {
    ...
    private void initializePayPalPayment(){
        PayPalPayment payment = new PayPalPayment(new BigDecimal(String.valueOf(totalCostPrice)), "CAD", "Watches", PayPalPayment.PAYMENT_INTENT_SALE);
